...
These two graphs suggests a sampling period of 01/01/2013 - 01/10/2020 after some cleaning. The most recent clinic date is 17/09/2020.  
...
``` {r}
# number of patients still alive at 01/01/2015
...
We will detect certain phrases from the clinic comment variable and assign those clinics to the correct category. After this process there are 529 clinics that are either `Other`. These are encounters that are not considered encounters with the ACHD service.

This leaves 6709 clinic records between 01/01/2013 and 01/10/2020, with patients seen at an ACHD clinics at RPAH (private, public or outreach) who are still alive.
