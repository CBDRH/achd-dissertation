...
sa2.count <- readRDS(file = paste(ACHD_path, 'output/sa2.count.rds', sep=""))

#import SA3 ACHD data
sa3.count <- readRDS(file = paste(ACHD_path, 'output/sa3.count.rds', sep=""))

#import SA4 ACHD data
sa4.count <- readRDS(file = paste(ACHD_path, 'output/sa4.count.rds', sep=""))
...
simple_sa3 <- merge(simple_sa3, sa3.count, by.x = 'SA3_NAME16', by.y = 'SA3_NAME_2016')
```
...
simple_sa4 <- merge(simple_sa4, sa4.count, by.x = 'SA4_NAME16', by.y = 'SA4_NAME_2016')
```
