...
SA2_locality <- read.csv(paste(study_folder, '/ASGS/asgs2016codingindexes/2019 Locality to 2016 SA2 Coding Index.csv', sep = ""))
...
# write the filtered lookup table to the output folder
 write.csv(SA2_lookup_NSW, "./analysis_pipeline/output/sa2_lookup.csv")
 write.csv(ASGS_lookup, "./analysis_pipeline/output/ASGS_lookup.csv")
