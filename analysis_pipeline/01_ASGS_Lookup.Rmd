...
# write the filtered lookup table to the output folder
 write.csv(SA2_lookup_NSW, "./achd-dissertation/analysis_pipeline/output/sa2_lookup.csv")
 write.csv(ASGS_lookup, "./achd-dissertation/analysis_pipeline/output/ASGS_lookup.csv")
