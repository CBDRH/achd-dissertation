...
htt_details <- read.csv('./input/myhospitals-contact-details.csv') %>%
                    ...
                    mutate(
                       ...
                       Hospital.name = replace(Hospital.name, 
                                               Hospital.name == "St Vincent<92>s Hospital [Darlinghurst]", 
                                               "St Vincents Hospital [Darlinghurst]"),
                       Hospital.name = replace(Hospital.name, 
                                               Hospital.name == "St Vincent's Private Sydney", 
                                               "St Vincents Private Sydney")
                    ) %>%
