...
HTML(paste(
            ...
            <br>
            <b>Number of ACHD Patients:</b> ", mask.achd(sum(selected_areas$ACHD_count), 'str'),"<br>
            <br>
            <b>Number with:</b> <br>
            <ul>
              <li>Simple CHD: ",mask.achd(sum(selected_areas$beth_1), 'str'),"</li>
              <li>Moderate CHD: ",mask.achd(sum(selected_areas$beth_2), 'str'),"</li> 
              <li>Complex CHD: ",mask.achd(sum(selected_areas$beth_3), 'str'),"</li>
            </ul>
            <b>Number of Patients lost to follow up:</b><br> 
            <ul>
              <li>",mask.achd(sum(selected_areas$ltf_3), 'str'),"</li>
            </ul>
