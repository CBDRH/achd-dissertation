...
All of the diagnosis variables code 1 for true and NA for untrue. To make it a little easier to read, we will recode the NAs in these variables to 0s.
...
MAIN <- MAIN %>% mutate_at(dx_names,
                            function(x) replace(x, (is.na(x) | x == -1), 0)
                           ) %>%
