...
# add to data set
sa2.data2 <- merge(sa2.data, childcare, by = 'sa2_area')
...
# add to data set
sa2.data3 <- merge(sa2.data2, employ, by = 'sa2_area')
...
# add to data set
sa2.data4 <- merge(sa2.data3, overcrowding, by = 'sa2_area')
...
# add to data set
sa2.data5 <- merge(sa2.data4, single_parent, by = 'sa2_area')
```
...
# add to data set
sa2.data6 <- merge(sa2.data5, student, by = 'sa2_area')
...
# add to data set
sa2.data7 <- merge(sa2.data6, age_cat, by = 'sa2_area')

```

__Add SA2 Codes to dataset__
...
sa2.data8 <- merge(sa2.data7, SA2_nsw, by.x = 'sa2_area', 'SA2_NAME_2016')
...
#write.csv(sa2.data8, "./achd-dissertation/EDA/output/sa2_table_builder.csv")
